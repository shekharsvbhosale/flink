...
public class StreamExecWindowJoin extends ExecNodeBase<RowData>
    ...
    protected Transformation<RowData> translateToPlanInternal(PlannerBase planner) {
        ...
        if (leftWindowing instanceof WindowAttachedWindowingStrategy) {
            leftWindowEndIndex = ((WindowAttachedWindowingStrategy) leftWindowing).getWindowEnd();
        } else {
            throw new TableException(leftWindowing.getClass().getName() + " is not supported yet.");
        }
        int rightWindowEndIndex;
        if (rightWindowing instanceof WindowAttachedWindowingStrategy) {
            rightWindowEndIndex = ((WindowAttachedWindowingStrategy) rightWindowing).getWindowEnd();
        } else {
            throw new TableException(
                    rightWindowing.getClass().getName() + " is not supported yet.");
        }
