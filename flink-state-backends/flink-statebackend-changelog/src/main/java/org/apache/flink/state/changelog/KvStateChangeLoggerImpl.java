...
@NotThreadSafe
class KvStateChangeLoggerImpl<Key, State, Ns> extends AbstractStateChangeLogger<Key, State, Ns>
    ...
    @Override
    protected void serializeState(State state, DataOutputViewStreamWrapper out) throws IOException {
        valueSerializer.serialize(state, out);
    }
